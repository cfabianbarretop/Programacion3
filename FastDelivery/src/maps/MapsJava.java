...
public abstract class MapsJava {
     ...
     * @return devuelve el estado de una petición con clave API. En caso de ser
     * válida, devuelve "OK", en cualquier otro caso la clave no es correcta.
    ...
    /**
     * Devuelve el tiempo de conexión máximo (milisegundos) de espera al
    ...
    /**
     * Establece el tiempo máximo de espera (milisegundos) por el servidor (NO
     * FUNCIONA)
     *
    ...
    /**
     * Obtiene la región de búsqueda de resultados (de forma predeterminada
     * "es"). Más info. sobre regiones en http://es.wikipedia.org/wiki/CcTLD
     *
    ...
    /**
     * Establece la región de búsqueda de resultados (de forma predeterminada
     * "es"). Más info. sobre regiones en http://es.wikipedia.org/wiki/CcTLD
     *
    ...
    /**
     * Obtiene el idioma en el que se muestran los resultados (de forma
     * predeterminada "es") Más info. sobre idiomas en
    ...
    /**
     * Establece el idioma en el que se muestran los resultados (de forma
     * predeterminada "es") Más info. sobre idiomas en
     * https://spreadsheets.google.com/pub?key=p9pdwsai2hDMsLkXsoM05KQ&gid=1
     *
    ...
    /**
     * Obtiene si se está utilizando sensor GPS (GNSS) en las peticiones para
     * obtener ubicación (de forma predeterminada es false)
     *
     * @return devuelve true en caso de utilización del sensor y false en caso
     * contrario
    ...
    /**
     * Establece el uso o no uso de un sensor GPS (GNSS) en las peticiones para
     * obtener ubicación (de forma predeterminada false)
     *
     * @param aSensor en caso de ser true, se fuerza a utilizar sensor. Si es
     * false, no se utiliza
    ...
    /**
     * Obtiene la clave actual de desarrollador de API Google Maps (sólo
     * necesario para Places)
     *
    ...
    /**
     * Establece clave de desarrollador API Google Maps (sólo necesario para
     * Places)
     *
    ...
    /**
     * Obtiene registro de todas las peticiones HTTP realizadas. Conforma un
     * String[n][6] con la siguiente estructura: <br/>
     * [0][0]="Número de petición";<br/>[0][1]="Fecha/hora
     * petición";<br/>[0][2]="status de la petición";<br/>
     * [0][3]="URL de la petición";<br/>[0][4]="Información sobre petición
     * realizada";<br/>[0][5]="Excepciones generadas";<br/>
     * Ejemplo:<br/>
     * [0][0]="1";<br/>[0][1]="Mon Oct 07 11:30:31 CEST
     * 2013";<br/>[0][2]="OK";<br/>
     * [0][3]=""http://maps.google.com/maps/api/geocode/xml?address=Madrid&region=es&language=es&sensor=false"";<br/>[0][4]="Geocoding
     * request";<br/>[0][5]="No exception";<br/>
     * Tipos de status:<br/>
     * OK: indica que la solicitud del API se realizó correctamente.<br/>
     * INVALID_REQUEST: indica que la solicitud del API se formó de forma
     * incorrecta.<br/>
     * OVER_QUERY_LIMIT: indica que el solicitante ha superado los límites.<br/>
     * REQUEST_DENIED: indica que el API no completó la solicitud, posiblemente
     * porque el solicitante no puedo incluir correctamente un parámetro sensor
     * válido.<br/>
     * UNKNOWN_ERROR: indica un error desconocido.<br/>
     * NO STATUS: indica un error al realizar la petición<br/>
     *
     * @return devuelve un array de dos dimensiones con las diferentes
    ...
    /**
     * Obtiene registro de la última petición HTTP realizada. Conforma un
     * String[6] con la siguiente estructura:</br>
     * [0]="Número de petición";<br/>[1]="Fecha/hora petición";<br/>[2]="status
     * de la petición";<br/>
     * [3]="URL de la petición";<br/>[4]="Información sobre petición
     * realizada";<br/>[5]="Excepciones generadas";<br/>
     * Ejemplo:<br/>
     * [0]="1";<br/>[1]="Mon Oct 07 11:30:31 CEST 2013";<br/>[2]="OK";<br/>
     * [3]="http://maps.google.com/maps/api/geocode/xml?address=Madrid&region=es&language=es&sensor=false";<br/>[4]="Geocoding
     * request";<br/>[5]="No exception";<br/>
     * Tipos de status:<br/>
     * OK: indica que la solicitud del API se realizó correctamente.<br/>
     * INVALID_REQUEST: indica que la solicitud del API se formó de forma
     * incorrecta.<br/>
     ...
     *
     * @return retorna string con URL de la última petición (por ejemplo,
     * "http://maps.google.com/maps/api/geocode/xml?address=Madrid&region=es&language=es&sensor=false"
     * @see MapsJava#getStockRequest()
     */
     ...
     *
     * @return retorna string con información de la última petición realizada
     * (por ejemplo, "Geocoding request")
     * @see MapsJava#getStockRequest()
     */
    ...
    /**
     * Devuelve información sobre la posible excepción generada en la última
     * petición.
     *
     * @return retorna string con información sobre error de la última petición
     * (por ejemplo, "No exception")
     * @see MapsJava#getStockRequest()
     */
